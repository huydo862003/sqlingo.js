...
class ExasolGenerator extends Generator {
  ...
  static get RESERVED_KEYWORDS (): Set<string> {
    return new Set([
      ...
      'check', 'checked', 'clob', 'close', 'coalesce', 'collate', 'collation',
      'collation_catalog', 'collation_name', 'collation_schema', 'column', 'commit', 'condition',
      'connect_by_iscycle', 'connect_by_isleaf', 'connect_by_root', 'connection', 'constant',
      'constraint', 'constraint_state_default', 'constraints', 'constructor', 'contains',
      'continue', 'control', 'convert', 'corresponding', 'create', 'cs', 'csv', 'cube',
      'current', 'current_cluster', 'current_cluster_uid', 'current_date', 'current_path',
      ...
      'datetime_interval_code', 'datetime_interval_precision', 'day', 'dbtimezone', 'deallocate',
      'dec', 'decimal', 'declare', 'default', 'default_like_escape_character', 'deferrable',
      'deferred', 'defined', 'definer', 'delete', 'deref', 'derived', 'desc', 'describe',
      'descriptor', 'deterministic', 'disable', 'disabled', 'disconnect', 'dispatch', 'distinct',
      'dlurlcomplete', 'dlurlpath', 'dlurlpathonly', 'dlurlscheme', 'dlurlserver', 'dlvalue',
      'do', 'domain', 'double', 'drop', 'dynamic', 'dynamic_function', 'dynamic_function_code',
      'each', 'else', 'elseif', 'elsif', 'emits', 'enable', 'enabled', 'end', 'end-exec',
      'endif', 'enforce', 'equals', 'errors', 'escape', 'except', 'exception', 'exec', 'execute',
      'exists', 'exit', 'export', 'external', 'extract', 'false', 'fbv', 'fetch', 'file',
      'final', 'first', 'float', 'following', 'for', 'forall', 'force', 'format', 'found',
      'free', 'from', 'fs', 'full', 'function', 'general', 'generated', 'geometry', 'get',
      'global', 'go', 'goto', 'grant', 'granted', 'group', 'group_concat', 'grouping', 'groups',
      'hashtype', 'hashtype_format', 'having', 'high', 'hold', 'hour', 'identity', 'if',
      'ifnull', 'immediate', 'impersonate', 'implementation', 'import', 'in', 'index',
      'indicator', 'inner', 'inout', 'input', 'insensitive', 'insert', 'instance',
      'instantiable', 'int', 'integer', 'integrity', 'intersect', 'interval', 'into', 'inverse',
      'invoker', 'is', 'iterate', 'join', 'key_member', 'key_type', 'large', 'last', 'lateral',
      'ldap', 'leading', 'leave', 'left', 'level', 'like', 'limit', 'listagg', 'localtime',
      'localtimestamp', 'locator', 'log', 'longvarchar', 'loop', 'low', 'map', 'match',
      'matched', 'merge', 'method', 'minus', 'minute', 'mod', 'modifies', 'modify', 'module',
      ...
      'preceding', 'preferring', 'prepare', 'preserve', 'prior', 'privileges', 'procedure',
      'profile', 'qualify', 'random', 'range', 'read', 'reads', 'real', 'recovery', 'recursive',
      'ref', 'references', 'referencing', 'refresh', 'regexp_like', 'relative', 'release',
      'rename', 'repeat', 'replace', 'restore', 'restrict', 'result', 'return',
      'returned_length', 'returned_octet_length', 'returns', 'revoke', 'right', 'rollback',
      'rollup', 'routine', 'row', 'rows', 'rowtype', 'savepoint', 'schema', 'scope',
      'scope_user', 'script', 'scroll', 'search', 'second', 'section', 'security', 'select',
      'selective', 'self', 'sensitive', 'separator', 'sequence', 'session', 'session_user',
      'sessiontimezone', 'set', 'sets', 'shortint', 'similar', 'smallint', 'some', 'source',
      'space', 'specific', 'specifictype', 'sql', 'sql_bigint', 'sql_bit', 'sql_char',
      'sql_date', 'sql_decimal', 'sql_double', 'sql_float', 'sql_integer', 'sql_longvarchar',
      'sql_numeric', 'sql_preprocessor_script', 'sql_real', 'sql_smallint', 'sql_timestamp',
      'sql_tinyint', 'sql_type_date', 'sql_type_timestamp', 'sql_varchar', 'sqlexception',
      'sqlstate', 'sqlwarning', 'start', 'state', 'statement', 'static', 'structure', 'style',
      'substring', 'subtype', 'sysdate', 'system', 'system_user', 'systimestamp', 'table',
      'temporary', 'text', 'then', 'time', 'timestamp', 'timezone_hour', 'timezone_minute',
      'tinyint', 'to', 'trailing', 'transaction', 'transform', 'transforms', 'translation',
      'treat', 'trigger', 'trim', 'true', 'truncate', 'under', 'union', 'unique', 'unknown',
